...
cmd /c mvn install:install-file -Dfile="temp/FishbansAPI-v%VERSION%.jar" -DgroupId=net.ae97 -DartifactId=FishBansAPI -Dversion=%VERSION% -Dpackaging=jar -DcreateChecksum=true
